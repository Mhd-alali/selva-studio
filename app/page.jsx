    ...
    <main className="">
      ...
      <section className="container space-y-10 my-20">
        ...
        <div className="grid grid-cols-1 place-items-center lg:grid-cols-5 gap-16 ">
          <ProcessCard image="/process/DISCOVERY.svg" title={"DISCOVERY"} body={'This is where we hop on a call and meet to explore your brand’s vision, and fill out the enquiry form, and receive the pricing guide.'} />
          <ProcessCard image="/process/RESEARCH.svg" title={"RESEARCH"} body={"This is where we were i’ll dive deep into some research, Checking out you’r cometitions,getting a fell for some design styles."} />
          <ProcessCard image="/process/DESIGNING.svg" title={"DESIGNING"} body={"i’ll create two moodboards ( in some cases just one if we’re already set on the style ) and i’ll send these over to you to choose from."} />
          <ProcessCard image="/process/SHOWCASE.svg" title={"SHOWCASE"} body={"I’ll prepare a comprehensive brand presentation showcasing the evolution of the designs and highlight the thought process behind each decision."} />
          <ProcessCard image="/process/FINALISE.svg" title={"FINALISE"} body={"After receiving any feedback and approve the project, make the final payment, and receive all your final files. "} />
        </div>
      </section>
